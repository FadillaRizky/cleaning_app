  ...
  static ListPackageResponse fromJson(Map<String, Object?> json) {
    return ListPackageResponse(
        ...
        data: json['data'] == null
            ? null
            : (json['data'] as List)
                .map<Data>((data) => Data.fromJson(data as Map<String, Object?>))
                .toList());
  }
...
class Data {
  ...
  const Data(
      ...
      this.packObjectDescription,
      this.packJobDescription,
      this.packProcedureDescription,
      this.packBannerPath,
      this.discPercentage,
      this.createdBy,
      this.updatedBy});
  ...
  static Data fromJson(Map<String, Object?> json) {
    return Data(
        ...
        packObjectDescription: json['pack_object_description'] == null
            ? null
            : json['pack_object_description'] as String,
        packJobDescription:
            json['pack_job_description'] == null ? null : json['pack_job_description'] as String,
        packProcedureDescription: json['pack_procedure_description'] == null
            ? null
            : json['pack_procedure_description'] as String,
        packBannerPath:
            json['pack_banner_path'] == null ? null : json['pack_banner_path'] as String,
