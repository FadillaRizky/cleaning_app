...
const Data({this.firstName , this.lastName , this.email , this.bornPlace , this.bod , this.religion , this.ktpAddress , this.avatarPath , this.level , this.discMember });
Data copyWith({String? firstName, String? lastName, String? email, dynamic? bornPlace, dynamic? bod, dynamic? religion, String? ktpAddress, String? avatarPath, String? level, int? discMember}){
return Data(
...
ktpAddress:json['ktp_address'] == null ? null : json['ktp_address'] as String,
avatarPath:json['avatar_path'] == null ? null : json['avatar_path'] as String,
level:json['level'] == null ? null : json['level'] as String,
discMember:json['disc_member'] == null ? null : json['disc_member'] as int
    );
}
