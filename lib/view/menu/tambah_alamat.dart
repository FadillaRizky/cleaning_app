import 'package:cleaning_app/widget/glassmorphic_textfield.dart' show buildKeyboardActionsConfig;
          ...
          Expanded(
            child: GetBuilder<AlamatController>(builder: (_) {
              return FutureBuilder(
                  ...
                  builder: (context, AsyncSnapshot<PropertyAddressResponse> snapshot) {
                          ...
                          return Column(
                            children: [
                              ListTile(
                                ...
                                title: Row(
                                  children: [
                                    Text(snapshot.data!.data![index].propertyType!,
                                        style: TextStyle(
                                ...
                                contentPadding: EdgeInsets.fromLTRB(45.r, 15.r, 15.r, 15.r),
                                tileColor: Colors.white,
                              ),
                              SizedBox(
                                height: 5,
    ...
    return Scaffold(
      ...
      body: KeyboardActions(
        config: buildKeyboardActionsConfig(
          context,
          fields: [
            (focusNode: controller.nameFocus, nextFocusNode: controller.phoneNumberFocus),
            (focusNode: controller.phoneNumberFocus, nextFocusNode: controller.detailAddressFocus),
            (focusNode: controller.detailAddressFocus, nextFocusNode: null),
          ],
        ),
        disableScroll: true,
        child: Column(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(controller.specificLocation.value,
                                                style: TextStyle(
                                                    fontSize: 43.sp,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FieldAlamat(
                            ...
                            nextFocusNode: controller.detailAddressFocus,
                            label: "Nomor Telepon",
                            controller: controller.phoneNumberController,
                            keyboardType: TextInputType.number,
                          ),
                          FieldAlamat(
                            focusNode: controller.detailAddressFocus,
                            nextFocusNode: null,
                          ...
                          onPressed: controller.isSaving.value
                              ...
                              : () async {
                                  ...
                                  var data = {
                                    ...
                                    "is_default": controller.isDefaultAddress.value ? "1" : "0"
                                  };
                                  if (isDetail) {
