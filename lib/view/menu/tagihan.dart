                      ...
                      children: [
                                    ...
                                    child: Column(
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Image.asset("assets/logo_qris.png", height: 65.h),
                                            Image.asset("assets/logo_gpn.png", height: 80.h),
                                          ],
                                        ),
                            ...
                            : Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Image.asset("assets/icon/bca_white.png", height: 68.h),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          GestureDetector(
                                            onTap: () {
                                              Clipboard.setData(
                                                  const ClipboardData(text: "168 0370 628"));
                                              IconSnackBar.show(context,
                                                  snackBarType: SnackBarType.alert,
                                                  label: 'Text berhasil disalin.');
                                            },
                                            child: Text(
                                              "Salin",
                                              style:
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () => controller.saveQrisToGallery(context),
                        ...
                        Center(
                            child: GestureDetector(
                                onTap: () {
                                  Get.toNamed("instruksi_pembayaran",
                                      arguments: {"metode_pembayaran": metodePembayaran});
                                },
                                child: Text(
                        ...
                        Container(
                          ...
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Icon(Icons.warning_amber_rounded, color: Colors.red, size: 63.r),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (!controller.validateDocument()) return;
                          print("metodePembayaran");

                          print(metodePembayaran);
                          final data = controller.buildOrderData(metodePembayaran);
                          controller.confirmPayment(data);
                        },
