    ...
    return Scaffold(
      ...
      body: Column(
        children: [
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    FutureBuilder(
                        future: controller.getDetailPackage(),
                        builder: (context,
          ...
          Obx((){
            return packController.category.value == "Deep Cleaning"
                ? Container(
                width: double.infinity,
                      ...
                      SizedBox(
                          ...
                          child: Obx(() {
                            ...
                            return ElevatedButton(
                              ...
                              onPressed: enabled
                                  ? () {
                                var listData = packController.resultDataObject.map((pack) {
                                  return {
                                    "pack_id": pack["pack_id"].toString(),
                                    "pack_category": packController.category.value,
                                    "pack_hour": "0", /// Deep Cleaning default 0
                                    "object_id": (pack["data_object"] as List).map((obj) => obj["object_id"].toString()).toList(),
                                    "object_price": (pack["data_object"] as List).map((obj) => obj["object_price"]).toList(),
                                  };
                                }).toList();
                                var data = {
                                  "data_pack": listData,
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                              Utils.formatCurrency(int.parse(
                                  packController.selectedPriceDuration.value) -
                                  int.parse(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(Utils.formatCurrency(int.parse(packController.selectedPriceDuration.value) + 2000),
                              style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold)),
                        ],
                        ...
                        return ElevatedButton(
                          ...
                          onPressed: enabled
                            ...
                            var data = {
                              "data_pack" : [
                                {
                                  "pack_id"       : int.parse(packController.selectedPackageId.value),
                                  "pack_category" : packController.category.value,
                                  "pack_hour"     : packController.selectedDuration.value,
                                  "object_id"     : [],
                                  "object_price"  : []
                                }
                              ],
