    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          context,
          fields: [
            (focusNode: controller.phoneNumberFocus,    nextFocusNode: controller.passwordFocus),
            (focusNode: controller.passwordFocus, nextFocusNode: null),
          ],
        ),
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text("Masuk untuk mengakses layanan aplikasi",
